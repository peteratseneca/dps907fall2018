...
// This was the originally-created web service controller
// It was renamed in Solution Explorer, to include an "Api" string

// Change the namespace to include the ".Api" suffix

namespace AssociationsIntro.Controllers.Api
{
    public class EmployeesController : ApiController
    {
        ...
        // Get one, with associated objects, use attribute routing

...
namespace ManageClaims.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            // Attention 11 - New user account registration, additional tasks
            ...
            // Attention 12 - Look at the custom claims, add code here...
            ...
            if (canRegister)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Attention 13 - Add custom claims that were submitted by the user/requestor; add code here...

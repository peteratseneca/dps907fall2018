...
namespace ManageClaims.Controllers
{
    public class Manager
    {
        ...
        // Manager methods that perform CRUD tasks on custom claims
        ...
        // Attention 03 - Manager methods that fetch etc. user account info
        // Used by the UAM (user account management) controller

        // Attention 04 - We MUST return COPIES of user accounts etc. - don't work directly with the ASP.NET Identity objects

        // Attention 06 - Get all user accounts
        ...
        // Attention 07 - Get one user account, by its 32-hex-character identifier
        ...
        // Attention 08 - get one user account, by its email address
        ...
        // Attention 09 - Get a collection of zero or more user accounts that match surname (case-insensitive)

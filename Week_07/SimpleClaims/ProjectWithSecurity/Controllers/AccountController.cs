...
{
    // Notice that this inherits from ApiController, and enables user account creation and management
    // Therefore you must interact with this programmatically (or with Fiddler)
    ...
    public class AccountController : ApiController
    {
        ...
        // Attention 22 - User account creation method, data package is defined by RegisterBindingModel
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            if (result.Succeeded)
            {
                // Attention 23 - Add the new claims that were submitted by the user/requestor

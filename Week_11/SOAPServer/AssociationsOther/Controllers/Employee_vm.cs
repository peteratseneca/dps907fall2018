...
namespace AssociationsOther.Controllers
{
    ...
    {
        // Employee, with "reports to" and "employees supervised" info
    ...
    {
        // Employee, with self-referencing AND associated info from other entities
    ...
    // Employee resource models that support the command pattern

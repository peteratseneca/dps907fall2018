...
namespace AssociationsOther.Controllers
{
    public class Manager
    {
        ...
        // Employee get by identifier, with self-associated info
        ...
        // Employee get by identifier, with all associated info
        ...
        // Methods that implement the command pattern for emplooyee tasks
        // Set and cler the employee's supervisor
        // Set and clear a job duty

        public void SetEmployeeSupervisor(EmployeeSupervisor item)
        {
            // Must get a valid reference to both objects before continuing
        ...
        // Address add, requires extra checking and processing
        ...
        // Address delete, also requires extra checking and processing

...
{
    // Employee entity, has many kinds of associations
    ...
    public class Employee
    {
        ...
        // Details for one-to-one, to the same entity (self-referencing)
        ...
        // Details for one-to-many, to the same entity (self-referencing)
        ...
        // Details for one-to-one, to another entity
        ...
        // Details for many-to-many, to another entity
        public ICollection<JobDuty> JobDuties { get; set; }
    }

    // Address entity, has to-one association with employee
    ...
    // JobDuty entity, has to-many association with employee
